...
**Note**: To install services [insight-api](https://github.com/instadex-android/instadex-insight-api) and [insight-ui](https://github.com/instadex-android/instadex-insight-ui) you'll need to clone the repositories locally.
